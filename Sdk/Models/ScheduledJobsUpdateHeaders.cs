...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class ScheduledJobsUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ScheduledJobsUpdateHeaders class.
        /// </summary>
        public ScheduledJobsUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public ScheduledJobsUpdateHeaders(string xMsErrorCode = default(string))
        {
