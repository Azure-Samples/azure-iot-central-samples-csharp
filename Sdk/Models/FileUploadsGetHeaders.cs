...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class FileUploadsGetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the FileUploadsGetHeaders class.
        /// </summary>
        public FileUploadsGetHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public FileUploadsGetHeaders(string xMsErrorCode = default(string))
        {
