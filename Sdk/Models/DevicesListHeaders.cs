...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class DevicesListHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DevicesListHeaders class.
        /// </summary>
        public DevicesListHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public DevicesListHeaders(string xMsErrorCode = default(string))
        {
