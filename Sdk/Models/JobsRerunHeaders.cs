...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// <summary>
    /// Defines headers for Rerun operation.
    /// </summary>
    public partial class JobsRerunHeaders
    {
        /// <summary>
        /// Initializes a new instance of the JobsRerunHeaders class.
        /// </summary>
        public JobsRerunHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public JobsRerunHeaders(string xMsErrorCode = default(string))
        {
