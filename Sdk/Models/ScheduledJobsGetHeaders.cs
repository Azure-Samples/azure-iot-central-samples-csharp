...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class ScheduledJobsGetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ScheduledJobsGetHeaders class.
        /// </summary>
        public ScheduledJobsGetHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public ScheduledJobsGetHeaders(string xMsErrorCode = default(string))
        {
