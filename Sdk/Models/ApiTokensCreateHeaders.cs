...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class ApiTokensCreateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ApiTokensCreateHeaders class.
        /// </summary>
        public ApiTokensCreateHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public ApiTokensCreateHeaders(string xMsErrorCode = default(string))
        {
