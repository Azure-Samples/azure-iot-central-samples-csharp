...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class UsersCreateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UsersCreateHeaders class.
        /// </summary>
        public UsersCreateHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public UsersCreateHeaders(string xMsErrorCode = default(string))
        {
