...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class DeviceGroupsRemoveHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeviceGroupsRemoveHeaders class.
        /// </summary>
        public DeviceGroupsRemoveHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public DeviceGroupsRemoveHeaders(string xMsErrorCode = default(string))
        {
