...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class DevicesUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DevicesUpdateHeaders class.
        /// </summary>
        public DevicesUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public DevicesUpdateHeaders(string xMsErrorCode = default(string))
        {
