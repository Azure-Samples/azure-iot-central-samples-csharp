...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class JobsGetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the JobsGetHeaders class.
        /// </summary>
        public JobsGetHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public JobsGetHeaders(string xMsErrorCode = default(string))
        {
