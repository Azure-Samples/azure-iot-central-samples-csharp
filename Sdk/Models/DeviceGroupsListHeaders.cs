...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class DeviceGroupsListHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeviceGroupsListHeaders class.
        /// </summary>
        public DeviceGroupsListHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public DeviceGroupsListHeaders(string xMsErrorCode = default(string))
        {
