...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class OrganizationsUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the OrganizationsUpdateHeaders class.
        /// </summary>
        public OrganizationsUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public OrganizationsUpdateHeaders(string xMsErrorCode = default(string))
        {
