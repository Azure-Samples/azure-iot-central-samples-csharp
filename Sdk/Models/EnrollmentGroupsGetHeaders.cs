...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class EnrollmentGroupsGetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the EnrollmentGroupsGetHeaders class.
        /// </summary>
        public EnrollmentGroupsGetHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public EnrollmentGroupsGetHeaders(string xMsErrorCode = default(string))
        {
