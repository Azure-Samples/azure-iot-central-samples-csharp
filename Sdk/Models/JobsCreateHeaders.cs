...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class JobsCreateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the JobsCreateHeaders class.
        /// </summary>
        public JobsCreateHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public JobsCreateHeaders(string xMsErrorCode = default(string))
        {
