...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class JobsResumeHeaders
    {
        /// <summary>
        /// Initializes a new instance of the JobsResumeHeaders class.
        /// </summary>
        public JobsResumeHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public JobsResumeHeaders(string xMsErrorCode = default(string))
        {
