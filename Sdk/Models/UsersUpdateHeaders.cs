...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class UsersUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UsersUpdateHeaders class.
        /// </summary>
        public UsersUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public UsersUpdateHeaders(string xMsErrorCode = default(string))
        {
