...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class FileUploadsUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the FileUploadsUpdateHeaders class.
        /// </summary>
        public FileUploadsUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public FileUploadsUpdateHeaders(string xMsErrorCode = default(string))
        {
