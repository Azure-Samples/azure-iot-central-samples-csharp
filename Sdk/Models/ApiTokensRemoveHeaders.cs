...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class ApiTokensRemoveHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ApiTokensRemoveHeaders class.
        /// </summary>
        public ApiTokensRemoveHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public ApiTokensRemoveHeaders(string xMsErrorCode = default(string))
        {
