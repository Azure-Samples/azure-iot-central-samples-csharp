...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class OrganizationsRemoveHeaders
    {
        /// <summary>
        /// Initializes a new instance of the OrganizationsRemoveHeaders class.
        /// </summary>
        public OrganizationsRemoveHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public OrganizationsRemoveHeaders(string xMsErrorCode = default(string))
        {
