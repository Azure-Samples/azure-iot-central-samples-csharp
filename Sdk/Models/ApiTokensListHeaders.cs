...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class ApiTokensListHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ApiTokensListHeaders class.
        /// </summary>
        public ApiTokensListHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public ApiTokensListHeaders(string xMsErrorCode = default(string))
        {
