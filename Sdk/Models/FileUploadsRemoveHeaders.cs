...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class FileUploadsRemoveHeaders
    {
        /// <summary>
        /// Initializes a new instance of the FileUploadsRemoveHeaders class.
        /// </summary>
        public FileUploadsRemoveHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public FileUploadsRemoveHeaders(string xMsErrorCode = default(string))
        {
