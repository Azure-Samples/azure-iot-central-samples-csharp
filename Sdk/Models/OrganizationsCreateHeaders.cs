...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class OrganizationsCreateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the OrganizationsCreateHeaders class.
        /// </summary>
        public OrganizationsCreateHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public OrganizationsCreateHeaders(string xMsErrorCode = default(string))
        {
