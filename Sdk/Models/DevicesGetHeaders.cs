...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class DevicesGetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DevicesGetHeaders class.
        /// </summary>
        public DevicesGetHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public DevicesGetHeaders(string xMsErrorCode = default(string))
        {
