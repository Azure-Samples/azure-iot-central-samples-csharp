...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// <summary>
    /// Defines headers for ListModules operation.
    /// </summary>
    public partial class DevicesListModulesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DevicesListModulesHeaders class.
        /// </summary>
        public DevicesListModulesHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public DevicesListModulesHeaders(string xMsErrorCode = default(string))
        {
