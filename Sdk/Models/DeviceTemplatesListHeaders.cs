...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class DeviceTemplatesListHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeviceTemplatesListHeaders class.
        /// </summary>
        public DeviceTemplatesListHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public DeviceTemplatesListHeaders(string xMsErrorCode = default(string))
        {
