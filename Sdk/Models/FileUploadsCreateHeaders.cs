...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class FileUploadsCreateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the FileUploadsCreateHeaders class.
        /// </summary>
        public FileUploadsCreateHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public FileUploadsCreateHeaders(string xMsErrorCode = default(string))
        {
