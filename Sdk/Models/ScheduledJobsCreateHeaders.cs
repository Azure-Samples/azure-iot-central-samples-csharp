...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class ScheduledJobsCreateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ScheduledJobsCreateHeaders class.
        /// </summary>
        public ScheduledJobsCreateHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public ScheduledJobsCreateHeaders(string xMsErrorCode = default(string))
        {
