...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class DevicesRunCommandHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DevicesRunCommandHeaders class.
        /// </summary>
        public DevicesRunCommandHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public DevicesRunCommandHeaders(string xMsErrorCode = default(string))
        {
