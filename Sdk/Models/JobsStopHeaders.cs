...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class JobsStopHeaders
    {
        /// <summary>
        /// Initializes a new instance of the JobsStopHeaders class.
        /// </summary>
        public JobsStopHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public JobsStopHeaders(string xMsErrorCode = default(string))
        {
