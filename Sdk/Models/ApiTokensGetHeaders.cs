...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class ApiTokensGetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ApiTokensGetHeaders class.
        /// </summary>
        public ApiTokensGetHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public ApiTokensGetHeaders(string xMsErrorCode = default(string))
        {
