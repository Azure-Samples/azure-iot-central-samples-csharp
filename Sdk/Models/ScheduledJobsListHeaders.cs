...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class ScheduledJobsListHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ScheduledJobsListHeaders class.
        /// </summary>
        public ScheduledJobsListHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public ScheduledJobsListHeaders(string xMsErrorCode = default(string))
        {
