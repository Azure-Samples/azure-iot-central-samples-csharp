...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class JobsListHeaders
    {
        /// <summary>
        /// Initializes a new instance of the JobsListHeaders class.
        /// </summary>
        public JobsListHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public JobsListHeaders(string xMsErrorCode = default(string))
        {
