...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class DeviceTemplatesGetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeviceTemplatesGetHeaders class.
        /// </summary>
        public DeviceTemplatesGetHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public DeviceTemplatesGetHeaders(string xMsErrorCode = default(string))
        {
