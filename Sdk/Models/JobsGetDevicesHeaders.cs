...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class JobsGetDevicesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the JobsGetDevicesHeaders class.
        /// </summary>
        public JobsGetDevicesHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public JobsGetDevicesHeaders(string xMsErrorCode = default(string))
        {
