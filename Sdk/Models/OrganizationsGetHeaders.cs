...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class OrganizationsGetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the OrganizationsGetHeaders class.
        /// </summary>
        public OrganizationsGetHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public OrganizationsGetHeaders(string xMsErrorCode = default(string))
        {
