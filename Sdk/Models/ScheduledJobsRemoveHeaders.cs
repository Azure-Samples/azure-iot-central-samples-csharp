...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class ScheduledJobsRemoveHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ScheduledJobsRemoveHeaders class.
        /// </summary>
        public ScheduledJobsRemoveHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public ScheduledJobsRemoveHeaders(string xMsErrorCode = default(string))
        {
