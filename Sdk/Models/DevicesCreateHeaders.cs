...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class DevicesCreateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DevicesCreateHeaders class.
        /// </summary>
        public DevicesCreateHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public DevicesCreateHeaders(string xMsErrorCode = default(string))
        {
