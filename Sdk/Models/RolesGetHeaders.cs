...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class RolesGetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the RolesGetHeaders class.
        /// </summary>
        public RolesGetHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public RolesGetHeaders(string xMsErrorCode = default(string))
        {
