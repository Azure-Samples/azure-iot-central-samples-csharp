...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class UsersRemoveHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UsersRemoveHeaders class.
        /// </summary>
        public UsersRemoveHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public UsersRemoveHeaders(string xMsErrorCode = default(string))
        {
