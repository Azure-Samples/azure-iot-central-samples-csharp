...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class OrganizationsListHeaders
    {
        /// <summary>
        /// Initializes a new instance of the OrganizationsListHeaders class.
        /// </summary>
        public OrganizationsListHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public OrganizationsListHeaders(string xMsErrorCode = default(string))
        {
