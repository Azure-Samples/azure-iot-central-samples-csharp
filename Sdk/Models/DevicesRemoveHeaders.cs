...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class DevicesRemoveHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DevicesRemoveHeaders class.
        /// </summary>
        public DevicesRemoveHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public DevicesRemoveHeaders(string xMsErrorCode = default(string))
        {
