...
namespace Microsoft.Azure.IoTCentral.Models
{
    ...
    /// </summary>
    public partial class DeviceGroupsGetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeviceGroupsGetHeaders class.
        /// </summary>
        public DeviceGroupsGetHeaders()
        {
            CustomInit();
        }
        ...
        /// occurred.</param>
        public DeviceGroupsGetHeaders(string xMsErrorCode = default(string))
        {
