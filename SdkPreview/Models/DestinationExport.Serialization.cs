...
{
    public partial class DestinationExport : IUtf8JsonSerializable
    {
        ...
        internal static DestinationExport DeserializeDestinationExport(JsonElement element)
        {
            ...
            return new DestinationExport(status.Value, Optional.ToList(errors), Optional.ToNullable(lastExportTime), id.Value, displayName, enabled, source, filter.Value, Optional.ToDictionary(enrichments), destinations, transform.Value);
        }
    }
}
