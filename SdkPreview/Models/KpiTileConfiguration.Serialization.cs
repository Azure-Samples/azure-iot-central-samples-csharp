...
{
    public partial class KpiTileConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static KpiTileConfiguration DeserializeKpiTileConfiguration(JsonElement element)
        {
            ...
            return new KpiTileConfiguration(type, queryRange, format.Value, group, devices, Optional.ToList(capabilities));
        }
    }
}
