...
{
    /// <summary> The property job data definition. </summary>
    public partial class PropertyJobData : JobData
    {
        /// <summary> Initializes a new instance of PropertyJobData. </summary>
        ...
        public PropertyJobData(string target, string path)
        {
        ...
        internal PropertyJobData(string type, string target, string path, object value) : base(type)
        {
            Target = target;
            Path = path;
            Value = value;
