...
{
    public partial class MapPropertyConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static MapPropertyConfiguration DeserializeMapPropertyConfiguration(JsonElement element)
        {
            ...
            return new MapPropertyConfiguration(type, Optional.ToNullable(zoomLevel), group, devices, Optional.ToList(capabilities));
        }
    }
}
