...
{
    public partial class PropertyTileConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static PropertyTileConfiguration DeserializePropertyTileConfiguration(JsonElement element)
        {
            ...
            return new PropertyTileConfiguration(type, format.Value, group, devices, Optional.ToList(capabilities));
        }
    }
}
