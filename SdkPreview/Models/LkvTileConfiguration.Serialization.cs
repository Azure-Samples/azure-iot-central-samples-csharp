...
{
    public partial class LkvTileConfiguration : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            writer.WriteStartObject();
            if (Optional.IsDefined(ShowTrend))
            {
                writer.WritePropertyName("showTrend");
                writer.WriteBooleanValue(ShowTrend.Value);
            }
        ...
        internal static LkvTileConfiguration DeserializeLkvTileConfiguration(JsonElement element)
        {
            Optional<bool> showTrend = default;
            ...
            {
                if (property.NameEquals("showTrend"))
                {
                    ...
                    showTrend = property.Value.GetBoolean();
                    continue;
                }
            ...
            return new LkvTileConfiguration(type, Optional.ToNullable(showTrend), format.Value, group, devices, Optional.ToList(capabilities));
        }
    }
}
