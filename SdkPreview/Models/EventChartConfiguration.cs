...
{
    /// <summary> Configuration specifying options for a event chart tile. </summary>
    public partial class EventChartConfiguration : TileConfiguration
    {
        /// <summary> Initializes a new instance of EventChartConfiguration. </summary>
        /// <param name="queryRange"> The query range configuration of the event chart. </param>
        ...
        public EventChartConfiguration(TimeQueryRangeConfiguration queryRange, string group, IEnumerable<string> devices)
        {
        ...
        internal EventChartConfiguration(string type, TimeQueryRangeConfiguration queryRange, string group, IList<string> devices, IList<TileCapability> capabilities) : base(type)
        {
            QueryRange = queryRange;
            Group = group;
            Devices = devices;
            Capabilities = capabilities;
            Type = type ?? "eventChart";
        }

        /// <summary> The query range configuration of the event chart. </summary>
