...
{
    /// <summary> Configuration specifying options for a property tile. </summary>
    public partial class PropertyTileConfiguration : TileConfiguration
    {
        /// <summary> Initializes a new instance of PropertyTileConfiguration. </summary>
        ...
        public PropertyTileConfiguration(string group, IEnumerable<string> devices)
        {
        ...
        /// <param name="format"> The format configuration of the property tile. </param>
        /// <param name="group"> The ID of the device group to display. </param>
        /// <param name="devices"> The list of associated devices to display. </param>
        /// <param name="capabilities"></param>
        internal PropertyTileConfiguration(string type, TextFormatConfiguration format, string group, IList<string> devices, IList<TileCapability> capabilities) : base(type)
        {
            Format = format;
            Group = group;
            Devices = devices;
        ...
        /// <summary> The format configuration of the property tile. </summary>
