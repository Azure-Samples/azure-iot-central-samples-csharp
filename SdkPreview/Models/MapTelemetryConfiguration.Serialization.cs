...
{
    public partial class MapTelemetryConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static MapTelemetryConfiguration DeserializeMapTelemetryConfiguration(JsonElement element)
        {
            ...
            return new MapTelemetryConfiguration(type, Optional.ToNullable(zoomLevel), group, devices, Optional.ToList(capabilities));
        }
    }
}
