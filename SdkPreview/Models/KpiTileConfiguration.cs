...
{
    /// <summary> Configuration specifying options for KPI tile. </summary>
    public partial class KpiTileConfiguration : TileConfiguration
    {
        /// <summary> Initializes a new instance of KpiTileConfiguration. </summary>
        /// <param name="queryRange"> The query range configuration of the KPI chart. </param>
        ...
        public KpiTileConfiguration(TimeQueryRangeConfiguration queryRange, string group, IEnumerable<string> devices)
        {
        ...
        /// <param name="queryRange"> The query range configuration of the KPI chart. </param>
        /// <param name="format"> The format configuration of the KPI tile. </param>
        /// <param name="group"> The ID of the device group to display. </param>
        /// <param name="devices"> The list of associated devices to display. </param>
        /// <param name="capabilities"></param>
        internal KpiTileConfiguration(string type, TimeQueryRangeConfiguration queryRange, TextFormatConfiguration format, string group, IList<string> devices, IList<TileCapability> capabilities) : base(type)
        {
            QueryRange = queryRange;
            Format = format;
            Group = group;
        ...
        /// <summary> The query range configuration of the KPI chart. </summary>
        public TimeQueryRangeConfiguration QueryRange { get; set; }
        /// <summary> The format configuration of the KPI tile. </summary>
