...
{
    public partial class ADGroupUser : IUtf8JsonSerializable
    {
        ...
        internal static ADGroupUser DeserializeADGroupUser(JsonElement element)
        {
            ...
            return new ADGroupUser(roles, id.Value, type, tenantId, objectId);
        }
    }
}
