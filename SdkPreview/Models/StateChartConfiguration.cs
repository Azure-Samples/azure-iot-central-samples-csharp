...
{
    /// <summary> Configuration specifying options for a state chart tile. </summary>
    public partial class StateChartConfiguration : TileConfiguration
    {
        /// <summary> Initializes a new instance of StateChartConfiguration. </summary>
        /// <param name="queryRange"> The query range configuration of the state chart. </param>
        ...
        public StateChartConfiguration(TimeQueryRangeConfiguration queryRange, string group, IEnumerable<string> devices)
        {
        ...
        internal StateChartConfiguration(string type, TimeQueryRangeConfiguration queryRange, string group, IList<string> devices, IList<TileCapability> capabilities) : base(type)
        {
            QueryRange = queryRange;
            Group = group;
            Devices = devices;
            Capabilities = capabilities;
            Type = type ?? "stateChart";
        }

        /// <summary> The query range configuration of the state chart. </summary>
