...
{
    /// <summary> Configuration specifying options for a map telemetry tile. </summary>
    public partial class MapTelemetryConfiguration : TileConfiguration
    {
        /// <summary> Initializes a new instance of MapTelemetryConfiguration. </summary>
        ...
        public MapTelemetryConfiguration(string group, IEnumerable<string> devices)
        {
        ...
        internal MapTelemetryConfiguration(string type, float? zoomLevel, string group, IList<string> devices, IList<TileCapability> capabilities) : base(type)
        {
            ZoomLevel = zoomLevel;
            Group = group;
            Devices = devices;
            Capabilities = capabilities;
            Type = type ?? "mapTelemetry";
        }
